define(['dojo/_base/declare', 'jimu/BaseWidget', "esri/symbols/SimpleMarkerSymbol", "esri/layers/FeatureLayer", "esri/toolbars/draw", "dojo/store/Memory", "esri/tasks/query", "dgrid/OnDemandGrid", "dgrid/Selection", "dojo/_base/array"],
function(declare, BaseWidget, SimpleMarkerSymbol, FeatureLayer, Draw,  Memory, Query, Grid, Selection, array) {
  
  return declare([BaseWidget], {

    

    baseClass: 'consultar-estado',
